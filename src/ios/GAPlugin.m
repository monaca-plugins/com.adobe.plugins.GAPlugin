...
- (void) trackEvent:(NSMutableArray*)arguments withDict:(NSMutableDictionary*)options
{
    ...
    if (inited)
    {
      ...
      [tracker send:[[GAIDictionaryBuilder createEventWithCategory:category action:eventAction label:eventLabel value:[NSNumber numberWithInt:eventValue]] build]];
      BOOL result = true;
...
//        BOOL    result = [tracker sendView:pageURL];
        BOOL result = true;
        if (result)
